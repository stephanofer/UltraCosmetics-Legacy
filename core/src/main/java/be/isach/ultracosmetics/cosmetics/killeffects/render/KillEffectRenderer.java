...
public interface KillEffectRenderer extends AutoCloseable {
    ...
    void hideFloatingHeadStand(UUID viewer, int entity);
    void equipIceHelmet(UUID viewer, int entity);
    void equipVictimHead(UUID viewer, int entity, VictimSnapshot victim);
    void spawnSquid(UUID viewer, int entity, double x, double y, double z, float yaw);
    ...
    void playSound(UUID viewer, Sound sound, double x, double y, double z, float volume, float pitch);
